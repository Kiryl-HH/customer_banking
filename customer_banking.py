...
def main():
    ...
    savings_maturity = int(input("Enter the length of months for your savings account: "))
    ...
    # ADD YOUR CODE HERE
    print(f"Interest earned at your savings account: {interest_earned}")
    ...
    cd_maturity = int(input("Enter the length of months for your CD account: "))
    ...
    # ADD YOUR CODE HERE
    print(f"Interest earned at your CD account: {interest_earned}")
